...
export default function Home() {
  ...
  return (
    <div className="backdrop w-screen h-full absolute bg-blue-400 z-20 invisible">
      <Navbar />

      <div className="w-full h-[100%] flex items-center flex-col md:flex md:items-center md:flex-col md:h-[90%%] md:w-[100%]">
        <div className="bg bg-black h-4/6 w-5/6 mt-36  md:w-4/6 md:h-3/5 md:bg-black opacity-40 md:mt-48 rounded-3xl sm:h-3/6 sm:mt-56"></div>
        ...
        >
          <video
            className="video h-full w-full object-cover invisible"

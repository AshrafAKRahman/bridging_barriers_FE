...
const JobApplication = () => {
  ...
  const listItems5 = [
    "It is easy to read : Anyone reading your CV is short on time. They’re not looking forward to processing a pile of applications. But if your CV is ready to go, you’ve used some tricks to make it easy to process. You’ve carefully weighed what to include, where to include it and how to word it.",
    "It has a professional-looking design : If you want your CV to be readable, you have to design it well. That means text placement, text size, white space, font type, font effects and whatever features you end up integrating: columns, colours, etc.",
    "Your CV highlights your transferable experiences : The person reading your CV is less interested in every task you perform than in the skills you can do as a result of performing those tasks. And not every skill you have needs to have been gained in that sector. Many soft skills can be transferred from jobs you just need to know how to frame them",
  ];

  const listItems6 = [
    "Write everything down : Immediately after your interview, write down     everything you can remember about it. Include things you wish you’d said and identify any weak points. Also jot down any questions you’d like to ask or information you’d need if you were made an offer. This is all useful learning",
    "Send a thank you email :  It’s polite to thank the interviewers and it also shows that you’re still interested in the role. Hopefully you’ll have asked for the contact details at the end of the interview but if someone from HR did the organising, then you can send your message to them to forward on. Ideally do this within 24 hours, but don’t wait longer than two to three days.",
    "Prepare for a job offer : We know you don’t have an offer yet and you don’t want to jinx it by being presumptuous, BUT you also don’t want to be on the back foot if you do receive good news. So now’s the time to prepare. Decide what your deal breakers are, work out the minimum salary you’d accept and how you’d want to negotiate. You could also be asked to provide references, so it’s a good idea to start preparing for this.",
    "Prepare for bad news : Just as you should be prepared for an offer, you should also prepare for a rejection. And by this we mean continue browsing and applying for jobs, and going to interviews. Having more options is good for a number of reasons: less disappointment if you don’t get a role, more practice at applying and interviewing and a better understanding of what you really want from your next role.",
  ];
  const listItems7 = [
    "Why do you want to work in the sector : If you really want to stand out, then you have to be very specific about it. Tell your interviewer what your contribution to the industry would be, what ideas and strategies you have, and why you’re passionate about this particular cause.",
    "Tell us about yourself : You have to tell the interviewer what you can really bring to the table. This is the chance to explain how your skills can help you succeed in the sector. Highlight any experience that you’ve had and confirm that you’re the right person for the role by explaining more about your past successes.",
    "What are your weaknesses : We all have our weaknesses. So when an interviewer asks this question, they want to know whether you are able to be honest about your flaws as well as approach them positively.",
    "Why should we hire you : This question is the best opportunity for you to highlight your unique skills. Consider this as your elevator pitch and think about which of your skills would be beneficial for this particular role.",
  ];

  const listItems8 = [
    "Carefully research the company you’re applying to : It’s not enough to glance at a company’s website in the five minutes before your interview. Statistics from Twin Employment &amp; Training show that 47% of interviewers wouldn’t offer the job to a candidate if they had little knowledge of their work. So take a deep-dive into your prospective future employer’s recent campaigns and initiatives",
    "Practise positive body language : A survey of 2,000 hiring managers found that 33% knew whether they would hire someone in the first 90 seconds. This shows how important first impressions really are. Remember to greet your interviewers with a warm smile and be prepared to briefly summarise your motivation for applying to their company and your career history, as these are the two things that are most commonly asked for at the beginning of every interview.",
    "Prepare for the most common questions related to your role : Take the time to do some research into the most commonly asked recruitment questions for your position. Then take your preparation a step further and think about the answers to these in the context of the charity you’re applying to.",
  ];

  const listItems9 = [
    "Don’t bad-mouth your past employers : It may be tempting, but it’s important to avoid bad-mouthing your previous employer. This shows your ability to remain professional and positive and won’t cast doubt on whether your attitude is right for the position you’re applying for.",
    "Don’t ignore the importance of research : Make sure that you take the time to carefully read through their website. Take in some of the recent initiatives and campaigns and understand the company’s values. It’s always impressive if you delve deeper into the role you’re applying for",
  ...
  const listItems10 = [
    ...
    "Learn from someone else’s journey : Learning from other people's behaviour and their resulting mistakes and successes is more efficient than figuring things out on your own.",
    "Discover which environment is right for you : Your work environment impacts your mood, drive, mental health and performance. If you work in a dreary office setting with unfriendly workers, you likely won't have enough confidence or job satisfaction to speak up.",
  ];
  return (

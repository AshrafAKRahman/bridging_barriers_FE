...
const ProfessionalSkills = () => {
  const listItems1 = [
    ...
    "Learn to balance your workload : Like lists. According to psychologist Art Markman, there are three psychological benefits to drawing up a list of tasks: 1 Writing things down makes you remember them better 2 Planning turns abstract goals into concrete work 3 It’s a useful exercise for fighting the interruptions that will inevitably come up. In other words, being more organised means you’re not letting other tasks get in the way of the big picture things you need to get done.",
    "Give yourself a digital detox : Often distracted by notifications popping up on your phone screen? You’ll be far more productive if you put your phone on flight mode during the working day.",
  ];
  const listItems2 = [
    "Developing a growth mindset is essential if you want to overcome obstacles you may face when learning something new, developing a new skill, securing a job or any difficulty that life throws at you really. See below five tips on how you can develop a growth mindset.",
    "Stop seeking approval from others : Instead, practise self-acceptance and self-approval. As you begin to trust yourself",
    "Self-reflection : Reflecting on your progress will help you develop a growth mindset. Daily, you should reflect on what you’ve done, what you’ve learnt and what steps you’re going to take next from whatever it is.",
    "See mistakes as opportunities to learn : Learning new things will help you to get out of your comfort zone and challenge yourself. You will see problems as challenges instead and adopt a growth mindset.",
    "Challenge yourself to try one new thing every day : Doing this will push you out of your comfort zone and challenge yourself. You are likely to discover new things you enjoy and learn more about yourself too!",
    "Focus on the journey, not the end goal : Sometimes, the end goal can be far and this can demotivate and discourage you. However, it is important to trust the process and focus on the experience. Focus on how you will learn and grow as a person, instead of asking yourself “what if it doesn’t work”.",
  ];
  const listItems3 = [
  ...
  const listItems4 = [
    ...
    "Stay organised : Organisation skills is one of the most sought after skills in employees and it’s something that employers look for in candidates. Having great organisation skills is really important and can help   you to stay on top of your workload, especially early in your career. One way that you can stay organised is to utilise your calendar to ensure you are up to date with tasks.",
  ];
  const listItems5 = [
